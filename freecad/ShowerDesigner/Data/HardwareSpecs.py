...
SLIDER_SYSTEM_SPECS = {
    ...
    "city_slider": {
        ...
        "dimensions": {
            ...
            "door_top_deduction_hd": 28,
            "door_top_deduction_clip": 30,
            "door_bottom_deduction": 10,
            "glass_cutout_depth_hd": 24,
            "glass_cutout_depth_clip": 26,
            "fixed_panel_door_clearance_hd": 16,
            "fixed_panel_door_clearance_clip": 12,
        ...
        "roller_variants": {
            "clip_in":    {"code": "CSL-RWH",    "glass_cutout_depth": 26,
                           "door_top_deduction": 30, "fixed_door_clearance": 12,
                           "max_weight_kg": 45, "door_glass_thickness": [6, 8]},
            "heavy_duty": {"code": "CSL-RWH-HD", "glass_cutout_depth": 24,
                           "door_top_deduction": 28, "fixed_door_clearance": 16,
